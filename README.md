...
**Brute force.** If there 10 or fewer stations, brute force check all permutations of the stations.
...
* In the branch where the solution **does not** use `a -> b`, we forbid the edge, which increases the lower bound because that was one of the edges used in the optimal solution.
