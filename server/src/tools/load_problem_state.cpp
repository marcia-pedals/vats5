...
int main(int argc, char* argv[]) {
  ...
  app.add_option("input_path", input_path, "Input JSON file path")->required();
  ...
  // Okay so the next thing I want to do: Figure out what some paths are that
  // are preventing some of the stops from being "inner".
